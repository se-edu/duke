# JavaFX Tutorial Part 2 - Creating a GUI for Frontend.Main

In this tutorial, we will be creating a GUI for Frontend.Main from scratch based on the following mockup.

![Mockup for Frontend.Main](assets/DukeMockup.png)
...
![Frontend.Main's layout](assets/DukeSceneGraph.png) 
...
![Frontend.Main's raw layout](assets/RawLayout.png)
...
![Frontend.Main's Final layout](assets/FinalLayout.png)
